...
x_axis = axisLength * R(1:2,2); %on the shorter edge
y_axis = axisLength * R(1:2,1); %on the longer edge
...
% Visual cue for the Z-axis pointing down at the camera
text(cx, cy, ' \odot Z_b', ...
'Color','c','FontSize',5,'FontWeight','bold');


%% 8. Marking the Center Frame (center of the base motor - our real-world axis)
...
%writing the coordinates in opposite order
