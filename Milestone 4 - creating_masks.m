function [redMask, blueMask, greenMask, yellowMask] = creating_masks(imgRGB)
...
yellowMask = b > 42; % Isolating yellow using the 'b' channel (blue-yellow)
...
blueMask = b < -24; % Isolating yellow using the 'b' channel (blue-yellow)
...
%% 3. Segment Red Block
redMask = a > 29; % Isolating yellow using the 'b' channel (blue-yellow)
...
greenMask = a < -19; % Isolating yellow using the 'b' channel (blue-yellow)
